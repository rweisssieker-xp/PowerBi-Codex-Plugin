...
This document lists the GitHub standard documents and templates used by the repository and explains what each one is for.

## de-DE Dokumentation

Dieses Dokument listet die GitHub-Standarddokumente und Templates des Repositorys und erklaert deren Zweck.
...
| `.github/SUPPORT.md` | Support and escalation guidance |
| `.github/DISCUSSION_TEMPLATE.md` | Discussion structure |
...
| `.github/ISSUE_TEMPLATE/*.yml` | Strukturierte Issue-Formulare |
| `.github/CODEOWNERS` | Review-Ownership-Routing |
