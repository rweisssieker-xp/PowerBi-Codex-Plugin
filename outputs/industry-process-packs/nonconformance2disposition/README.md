# Nonconformance2Disposition Process Pack

Generated process-pack specification for `nonconformance2disposition`.
...
Demo data: `../industry-demo-data/nonconformance2disposition/`.
