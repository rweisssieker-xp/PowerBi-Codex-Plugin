...
| File | Role |
| --- | --- |
| `README.md` | Entry point and product summary |
| `DOCUMENTATION.md` | Canonical doc index |
...
| `SUPPORT.md` | Help and escalation |
| `GOVERNANCE.md` | Decision rules |
| `MAINTAINERS.md` | Maintainer ownership |
| `RELEASE.md` | Release expectations |
...
| `.github/SUPPORT.md` | Support hints |
| `.github/DISCUSSION_TEMPLATE.md` | Discussion layout |
